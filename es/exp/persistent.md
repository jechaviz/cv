...
**Persistent Systems** es una multinacional de ingeniería digital enfocada en la modernización empresarial y servicios de ingeniería de productos de software para líderes globales en tecnología y finanzas.

### Propósito del puesto
Liderar la construcción del equipo técnico y el framework organizacional para una iniciativa estratégica multinacional de **Visa**, enfocada en la expansión de servicios financieros digitales.

### Responsabilidades transversales del puesto
* Liderar el proceso de reclutamiento y selección de perfiles técnicos de distintos niveles (junior, mid-level, senior).
* Definir el framework operativo y documental para el equipo de TI en alineación con los estándares globales de Visa.
* Establecer políticas de desarrollo seguras y entornos de trabajo estandarizados.
* **Gobierno Técnico:** Ejecutar pair reviews estratégicos y emitir la aprobación técnica final para puestas en producción críticas.
