# Consultor Senior
**Tata Consultancy Services (BNY Mellon Pershing)** – Remoto / Global
**Agosto 2021 – Diciembre 2022**

### Contexto de la empresa
**BNY Mellon** es el banco custodio más grande del mundo y una potencia en servicios de inversión. El proyecto se centró en la modernización de sus plataformas de custodia y servicios financieros para instituciones.

### Propósito del puesto
Modernizar las capacidades de Backend y la arquitectura de APIs para los servicios de banca institucional de **BNY Mellon**, liderando la integración de múltiples sistemas de facturación en un HUB centralizado de alta disponibilidad.
...
`Java 11` · `Spring Boot` · `Angular` · `Docker` · `Ansible` · `Kafka` · `JFrog` · `Nexus` · `SonarQube` · `Mockito` · `JMeter`
